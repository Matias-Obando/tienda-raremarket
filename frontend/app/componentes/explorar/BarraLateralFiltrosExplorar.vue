  ...
  <aside :class="['filters-panel', { 'filters-panel--open': isOpen }]">
    ...
    <section class="filters-section">
      <div class="filters-section__head">
        <h3>Categoría</h3>
        <NuxtLink to="/inicio" class="filters-reset">Limpiar</NuxtLink>
      </div>
...
import { getSubcategoriesByKey } from '~/constantes/categorias'
...
function updateQuerySelect(field: 'genero' | 'talla' | 'estado', event: Event) {
  ...
  return navigateTo({ path: '/inicio', query: next })
}
