<template>
  <footer class="site-footer" role="contentinfo" aria-labelledby="footer-brand">
        ...
        <div class="left">
          ...
          <div class="social" aria-label="Redes sociales">
            <a class="icon" href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram">
              <img class="icon-img" src="/iconos-integraciones/instagram.svg" alt="Instagram" />
            </a>

            <a class="icon" href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Facebook">
              <img class="icon-img" src="/iconos-integraciones/facebook.svg" alt="Facebook" />
            </a>
          </div>
        </div>
    ...
    <div class="footer-bottom" role="contentinfo">
      <div class="payments" role="list" aria-label="Métodos de pago">
        <img class="pay-img" src="/iconos-integraciones/googlepay.svg" alt="Google Pay" role="listitem" />
        <img class="pay-img" src="/iconos-integraciones/applepay.svg" alt="Apple Pay" role="listitem" />

        <div class="pay pay-mastercard" role="listitem" aria-label="Mastercard" title="Mastercard">
          <svg viewBox="0 0 48 20" width="48" height="20" xmlns="http://www.w3.org/2000/svg" aria-hidden="false" focusable="false" role="img">
            <title>Mastercard</title>
            <circle cx="18" cy="10" r="7.5" fill="#EB001B"/>
            <circle cx="30" cy="10" r="7.5" fill="#F79E1B" />
            <path d="M24,10 a6,6 0 0,1 0,-0.1 6,6 0 0,1 0,0.1" fill="rgba(0,0,0,0.06)" opacity="0.05"/>
          </svg>
        </div>

        <img class="pay-img" src="/iconos-integraciones/visa.svg" alt="Visa" role="listitem" />
      </div>
    </div>
  </footer>
</template>
...
.left { display:flex; gap:14px; flex-direction:column; }
.brand {
  font-weight: 800;
  font-size: 24px;
  text-transform: none;
...
@media (max-width: 740px) {
  .container { grid-template-columns: 1fr; gap: 18px; padding: 20px 16px; }
  .legal { order: 2; }
  .payments { gap: 12px; padding: 0 8px; }
  .pay-img, .pay-mastercard svg { height: 22px; }
}
</style>
