    ...
    <div class="auth-shell">
      <div class="auth-visual">
        <div class="auth-visual__overlay">
          ...
          <NuxtLink to="/inicio" class="auth-visual__link">Ir al inicio</NuxtLink>
        </div>
      </div>
      ...
      <div class="auth-panel">
        <div class="auth-brand">
          ...
          <NuxtLink to="/inicio" class="auth-brand__link">Volver a Inicio</NuxtLink>
        </div>
          ...
          <transition name="fade" mode="out-in">
            ...
            <form v-else key="login" class="split-form" @submit.prevent="submitLogin">
              ...
              <div style="text-align: center; margin-top: 6px; display: flex; flex-direction: column; gap: 8px;">
                <NuxtLink to="/autenticacion/forgot" class="split-help-link">¿Olvidaste tu contraseña?</NuxtLink>
...
function getRedirectPath() {
  ...
  return typeof redirect === 'string' && redirect.startsWith('/') ? redirect : '/inicio'
}
...
.auth-visual {
  ...
  background:
    ...
    url('/fondos/armario.png') center center / cover no-repeat;
}
