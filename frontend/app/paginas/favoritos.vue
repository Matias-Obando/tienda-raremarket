  ...
  <div class="favorites-page">
    <section class="favorites-shell">
      <article class="favorites-card favorites-card--header">
        ...
        <NuxtLink to="/inicio" class="favorites-link favorites-link--soft">Seguir explorando</NuxtLink>
      </article>
      ...
      <article class="favorites-card">
        ...
        <div v-else-if="!favoriteItems.length" class="empty empty--wide">
          Aún no tienes favoritos. Guarda artículos desde el catálogo para verlos aquí.
        </div>
