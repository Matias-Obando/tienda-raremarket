    ...
    <div :class="['rm-container', 'explore-layout', { 'no-sidebar': showPromoHero }]">
      ...
      <main class="explore-content">
        <div v-if="!showPromoHero" class="explore-head">
          <div>
            <p class="explore-kicker">Inicio</p>
            <h2 id="catalogo">Catálogo destacado</h2>
        ...
        <div v-if="filteredItems.length === 0" class="empty">
          ...
          <div class="emptyActions">
            <NuxtLink to="/inicio" class="pill">Ver todos</NuxtLink>
          </div>
        </div>
...
import ExploreFiltersSidebar from '~/componentes/explorar/BarraLateralFiltrosExplorar.vue'
import { useItemsStore } from '~/tiendas/useArticulosStore'
import {
...
const promoHeroImage = '/fondos/bg.png'
