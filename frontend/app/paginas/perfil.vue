  ...
  <div class="profile-page">
    <section v-if="sessionReady && profileUser" class="profile-grid">
      <article class="profile-card profile-card--hero">
        <NuxtLink to="/editar-perfil" class="profile-link profile-link--soft profile-edit-top">Editar perfil</NuxtLink>
        ...
        <div class="hero-actions">
          ...
          <NuxtLink to="/inicio" class="profile-link profile-link--soft">Ver catálogo</NuxtLink>
    ...
    <section v-if="sessionReady && !profileUser" class="profile-card profile-card--guest">
      ...
      <div class="hero-actions">
        <NuxtLink to="/autenticacion?mode=login&redirect=/perfil" class="profile-link">
          Iniciar sesión
        </NuxtLink>
        <NuxtLink to="/perfil?demo=1" class="profile-link profile-link--soft">
          Ver vista demo
        </NuxtLink>
      </div>
    </section>
...
import type { SessionUser } from '~/utilidades/useUsuarioSesion'
...
const quickActions = [
  ...
  { to: '/inicio', title: 'Buscar gangas', description: 'Descubre piezas interesantes para tu armario.', cta: 'Ir al inicio' }
]
